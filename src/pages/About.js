  ...
  return (
    <div className="about-page">
      ...
      <div className="about-content">
        <img 
          src="https://via.placeholder.com/300" // Replace with your photo URL
          alt="Your Name"
          className="about-image"
        />
        <div className="about-text">
          <p>
            Hello! I'm <strong>Your Name</strong>, a passionate front-end developer specializing in creating engaging and responsive web applications. With a keen eye for design and attention to detail, I strive to bring ideas to life through code.
          </p>
          <p>
